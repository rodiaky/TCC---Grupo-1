    ...
    <main>
        <section class="info-correcao">
            ...
            <div class="container-tema">
                <div class="info-tema">Nicolau, meu patinho</div>
                <div class="info-banca">Unicamp</div>
            </div>
        </section>
        ...
        <section class="section-cinza lista-codigos-correcao">
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown1">
                    <li><input type="checkbox" name="A"><p><b>A1.</b> Título: centralize-o, sem aspas ou grifo, sem ponto final. Deve ser criativo, adequado ao tema e relacionado ao texto, à tese e aos repertórios.</p></li>
                    <li><input type="checkbox" name="A"><p><b>A2.</b> Respeite as margens.</p></li>
                    <li><input type="checkbox" name="A"><p><b>A3.</b> Número: de zero a dez por extenso (exceto horas, datas e distâncias).</p></li>
                </ul>
            </article>
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown2">
                    <li><input type="checkbox" name="G"><p><b>G1.</b> Pontuação: Não separe elementos com relação sintática direta por vírgulas.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G2.</b> Ortografia.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G3.</b> Concordância.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G4.</b> Regência.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G5.</b> Colocação pronominal.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G6.</b> Acentuação.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G7.</b> Crase.</p></li>
                    <li><input type="checkbox" name="G"><p><b>G8.</b> Separação silábica.</p></li>
                </ul>
            </article>
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown3">
                    <li><input type="checkbox" name="E"><p><b>E1.</b> A tese deve ser objetiva – não misture argumentos à tese.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E2.</b> Parágrafo argumentativo curto, com pouca informação.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E3.</b> Organize melhor os argumentos/as ideias.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E4.</b> Texto circular.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E5.</b> Não elabore parágrafos que tenham um só período.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E6.</b> Não misture os argumentos à conclusão (ideia nova).</p></li>
                    <li><input type="checkbox" name="E"><p><b>E7.</b> Conclusão ou desfecho não compatível.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E8.</b> Texto sem tese/sem posicionamento.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E9.</b> A tese deve estar no 1º § (introdução).</p></li>
                    <li><input type="checkbox" name="E"><p><b>E10.</b> Observe a estrutura do § argumentativo.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E11.</b> Parágrafo sem Tópico Frasal.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E12.</b> Falta Evidência/Exemplificação.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E13.</b> Falta autoria/aprofunde a Análise/falta Análise.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E14.</b> Relacione melhor Evidência e Análise.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E15.</b> Falta Fechamento.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E16.</b> Reproduza a frase temática integralmente.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E17.</b> Defina/explicite a tese.</p></li>
                    <li><input type="checkbox" name="E"><p><b>E18.</b> Retome a tese e os Tópicos Frasais.</p></li>                
                </ul>
            </article>
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown4">
                    <li><input type="checkbox" name="C"><p><b>C1.</b> Argumentação superficial, pouco convincente.</p></li>
                    <li><input type="checkbox" name="C"><p><b>C2.</b> Uso precário ou insuficiente dos textos de apoio.</p></li>
                    <li><input type="checkbox" name="C"><p><b>C3.</b> Explicações desnecessárias.</p></li>
                    <li><input type="checkbox" name="C"><p><b>C4.</b> Insuficiência de ideias.</p></li>
                    <li><input type="checkbox" name="C"><p><b>C5.</b> Reprodução de senso comum.</p></li>
                    <li><input type="checkbox" name="C"><p><b>C6.</b> Redundância. </p></li>
                    <li><input type="checkbox" name="C"><p><b>C7.</b> Amplie o conteúdo. </p></li>
                    <li><input type="checkbox" name="C"><p><b>C8.</b> Explore esta ideia. </p></li>
                    <li><input type="checkbox" name="C"><p><b>C9.</b> Ideia mal explicada/lacuna. </p></li>
                    <li><input type="checkbox" name="C"><p><b>C10.</b> Falta repertório/repertório não produtivo. </p> </li>
                    <li><input type="checkbox" name="C"><p><b>C11.</b> Sobreposição de ideias/lacunas. </p></li>
                    <li><input type="checkbox" name="C"><p><b>C12.</b> Não reproduza modelos prontos de redação. </p></li>
                </ul>
            </article>
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown5">
                    <li><input type="checkbox" name="L"><p><b>L1.</b> Mantenha o nível padrão: evite informalidades.</p></li>
                    <li><input type="checkbox" name="L"><p><b>L2.</b> Melhore a linguagem, valorizando suas ideias.</p></li>
                    <li><input type="checkbox" name="L"><p><b>L3.</b> Não se dirija ao leitor; evite apelos.</p></li>
                    <li><input type="checkbox" name="L"><p><b>L4.</b> Linguagem coloquial.</p></li>
                    <li><input type="checkbox" name="L"><p><b>L5.</b> Evite subjetivismos e intromissões. Não utilize a primeira pessoa do singular.</p></li>
                    <li><input type="checkbox" name="L"><p><b>L6.</b> Palavra inadequada ao contexto. Consulte o dicionário. Desvio lexical. </p></li>
                </ul>
            </article>
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown6">
                    <li><input type="checkbox" name="S"><p><b>S1.</b> Melhore a elaboração dos períodos, mantendo a clareza e a coesão/problema de construção frasal (Estrutura sintática).</p></li>
                    <li><input type="checkbox" name="S"><p><b>S2.</b> Atente-se à coesão entre os parágrafos; não os fragmente.</p></li>
                    <li><input type="checkbox" name="S"><p><b>S3.</b> Ideias desconexas.</p></li>
                    <li><input type="checkbox" name="S"><p><b>S4.</b> Ausência de conectivo.</p></li>
                    <li><input type="checkbox" name="S"><p><b>S5.</b> Uso indevido de conectivo.</p></li>
                    <li><input type="checkbox" name="S"><p><b>S6.</b> Varie os elementos coesivos/repetição de coesivos.</p></li>              
                </ul>
            </article>
            ...
            <article class="container-codigo">
                ...
                <ul class="options-codigo" id="dropdown7">
                    <li><input type="checkbox" name="R"><p><b>R1.</b> Ideias contraditórias/incoerência.</p></li>
                    <li><input type="checkbox" name="R"><p><b>R2.</b> Fuga ao tema.</p></li>
                    <li><input type="checkbox" name="R"><p><b>R3.</b> Tangenciamento do tema.</p></li>
                    <li><input type="checkbox" name="R"><p><b>R4.</b> Incompatibilidade de ideias.</p></li>
                    <li><input type="checkbox" name="R"><p><b>R5.</b> Ideias desarticuladas.</p></li>
                    <li><input type="checkbox" name="R"><p><b>R6.</b> Evite generalizações e preconceitos.</p></li>           
                </ul>
            </article>
