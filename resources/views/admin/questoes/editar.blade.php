...
@section('conteudo')
    ...
    <article>
        ...
        <form action="{{ route('admin.questoes.atualizar', $questoes->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="inputbox">
                ...
                <div id="alternativa" class="select">
                    <div class="selected">
                        <span id="text-selected-alternativa">{{$questoes->resposta}}</span>
                ...
                <div id="categoria" class="select">
                    <div class="selected">
                        <span id="text-selected-categoria">{{$questoes->disciplina}}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="arrow">
                            <path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"></path>
                        </svg>
                    </div>
                ...
                <input type="hidden" name="disciplina" id="disciplina" value="{{ isset($questoes->disciplina) ? $questoes->disciplina : '' }}">
                  ...
                  <div class="select"> <!--Select para banca-->
                        <div class="selected">
                            ...
                            <span id="text-selected-banca">{{$questoes->banca_nome}}</span>
                            <svg
