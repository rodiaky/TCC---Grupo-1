...
<main>
    ...
    <button type="button" class="botao">
        ...
        <div class="botao-expand">
            <a href="{{ route('admin.pagamentos.adicionar', ['id' => $user->id]) }}" class="botao-texto">Adicionar
                Pagamento</a>
        </div>
    </button>
    ...
    <section class="info-aluno">
        ...
        <div class="container-info">
            ...
            <div class="container-turma"></div>
            <div class="turma-aluno">{{ $turma->dias_aula }} - {{ $turma->horario_entrada }}</div>
        </div>
    </section>
            ...
            <div id="selecionar-seta">
                <select id="examSelect" class="form-control selecionar">
                    @foreach($bancas as $banca)
                        <option value="{{ $banca->id }}" {{ $examType == $banca->id ? 'selected' : '' }}>
                            {{ $banca->nome }}
                        </option>
                    @endforeach
                </select>
