...
@section('conteudo')
    ...
    <article>
        ...
        <form action="{{ route('admin.bancas.salvar') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="inputbox" id="nota-max">
                    ...
                    <input type="number" name="nota_maxima_banca" min="0" max="1000" value="{{ isset($bancas->nota_maxima_criterio) ? $bancas->nota_maxima_criterio : '' }}" >
                </div>
