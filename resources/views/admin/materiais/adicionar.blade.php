...
@section('conteudo')
    ...
    <main>
        <div class="container-titulo-seta">
           <div class="container-seta">
            ...
            <h1 class="titulo-pagina">Adicionar Material</h1>
        </div>
    ...
    <article>
        <div class="form-value">
            <form action="{{ route('admin.materiais.salvar') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <br>
                    ...
                    <div class="select"> 
                        <div class="selected">
                            ...
                            <span id="text-selected-theme">Pasta</span>
                        ...
                        <input type="hidden" id="id_pasta" name="id_pasta" value="{{ isset($materiais->id_pasta) ? $materiais->id_pasta : '' }}" /> <!-- Hidden input for ID -->
                    </div><!--Select Tema-->
