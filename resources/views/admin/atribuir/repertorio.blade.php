...
@section('css')
    ...
    <title>Atribuir Repertório</title>
    @endsection
...
<main>
    <div class="container-titulo-seta">
       <div class="container-seta">
        ...
        <h1 class="titulo-pagina">Atribuir Repertório</h1>
    </div>
...
<article>
    <div class="form-value">
        <form action="{{ route('admin.atribuir.salvarRepertorio') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
