...
@section('css')
    ...
    <title>Adicionar Pagamwnto</title>
@endsection
    ...
    <main>
        <div class="container-titulo-seta">
           <div class="container-seta">
            ...
            <h1 class="titulo-pagina">Adicionar Pagamento</h1>
        </div>
        ...
        <div class="form-value">
            <form action="{{ route('admin.pagamentos.salvar') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="inputbox">
                    ...
                    <input type="text" name="valor" value="{{ isset($repertorios->valor) ? $repertorios->valor : '' }}" required>
                </div>
                ...
                <div class="addAltRep">
                    ...
                    <div class="select"> 
                        <div class="selected">
                            ...
                            <span id="text-selected-mes">Mês</span>
                    ...
                    <div class="select"> 
                        <div class="selected">
                            ...
                            <span id="text-selected-mes">Status</span>
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="arrow">
                                <path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"></path>
                            </svg>
                        </div>
