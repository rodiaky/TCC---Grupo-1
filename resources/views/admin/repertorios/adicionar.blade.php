        ...
        <div class="form-value">
            <form action="{{ route('admin.repertorios.salvar') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="inputbox">
                    ...
                    <textarea class="content" name="descricao" >{{ isset($repertorios->descricao) ? $repertorios->descricao : '' }}</textarea>
                </div>
                ...
                <div class="addAltRep">
                    ...
                    <div class="select"> 
                        ...
                        <input type="hidden" id="id_pasta" name="id_pasta" value="{{ isset($repertorios->id_pasta) ? $repertorios->id_pasta : '' }}" /> <!-- Hidden input for ID -->
                    </div><!--Select Tema-->
                    ...
                    <div class="select"> 
                        <div class="selected">
                            ...
                            <span id="text-selected-categoria">Classificação</span>
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="arrow">
                                <path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"></path>
                            </svg>
                        </div>
                        ...
                        <input type="hidden" id="classificacao" name="classificacao" value="{{ isset($repertorios->classificacao) ? $repertorios->classificacao : '' }}" />
